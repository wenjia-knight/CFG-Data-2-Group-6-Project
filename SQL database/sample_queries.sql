...
SELECT artist, title, COUNT(*) AS weeks_on_chart, f.mood
...
-- What are the songs from WEEKEND that has been in chart in the past five years?
...
-- 10 most popular artists in the past five years
